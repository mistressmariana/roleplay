...
function createParticlesBackground() {
    ...
    if (!particlesContainer) {
        console.warn('Particles background container not found');
        return;
    }
